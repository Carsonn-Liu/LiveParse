...
async function _soop_getDanmakuContext(payload) {
...
function _soop_danmakuDriver() {
  var driver = globalThis.__soopDanmakuDriver;
  if (!driver) {
    _soop_throw("UNSUPPORTED", "soop danmaku driver is unavailable", {});
  }
  return driver;
}

globalThis[__soop_sharedGlobalKey] = {
  throwError: _soop_throw,
  toString: _soop_str,
  getDanmakuContext: _soop_getDanmakuContext,
};
...
globalThis.LiveParsePlugin = {
  ...
  async getDanmaku(payload) {
    return await _soop_danmakuDriver().getDanmakuPlan(payload || {});
  },

  async createDanmakuSession(payload) {
    return await _soop_danmakuDriver().createDanmakuSession(payload || {});
  },

  async onDanmakuOpen(payload) {
    return await _soop_danmakuDriver().onDanmakuOpen(payload || {});
  },

  async onDanmakuFrame(payload) {
    return await _soop_danmakuDriver().onDanmakuFrame(payload || {});
  },

  async onDanmakuTick(payload) {
    return await _soop_danmakuDriver().onDanmakuTick(payload || {});
  },

  async destroyDanmakuSession(payload) {
    return await _soop_danmakuDriver().destroyDanmakuSession(payload || {});
  },
