...
async function _kick_fetchOfficialTokenFromWorker() {
  ...
  if (!body || statusCode >= 400 || !_kick_normalizeAccessToken(body.accessToken)) {
    _kick_throw("AUTH_FAILED", "kick token server request failed", {
  ...
  _kick_runtime.oauth = {
    accessToken: _kick_normalizeAccessToken(body.accessToken),
    tokenType: _kick_str(body.tokenType || "Bearer"),
    expiresAt: _kick_int(body.expiresAt, 0) > 0 ? _kick_int(body.expiresAt, 0) * 1000 : 0
  };
